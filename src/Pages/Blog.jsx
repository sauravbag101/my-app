...
const Blog = () => {
  ...
  */}
  ...
  {/*
    - custom css link
  */}
  <link rel="stylesheet" href="./assets/css/style.css"type='stylesheet' />
  {/*
    - google font link
  */}
          ...
          <li className="blog-post-item">
            ...
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_500,h_500,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-goog/events/image_qskyiCE.png"
                    alt="Design conferences in 2022"
                    loading="lazy"
                  />
                </figure>
                <div className="blog-content">
                  <div className="blog-meta">
                    <p className="blog-category">Design</p>
                    <span className="dot" />
                    <time dateTime="2022-02-23">Sep 07, 2024</time>
                  </div>
                  <h3 className="h3 blog-item-title">
                  I/O Extended Gurugram 2024
                  </h3>
                  <p className="blog-text">
                  The event is an extension of Google I/O Connect and focuses on Google I/O highlights Google developer community. 
                  </p>
                </div>
              </a>
            </li>
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://d8it4huxumps7.cloudfront.net/uploads/images/150x150/uploadedManual-64816a1a1330a_logo__3_.png?d=200x200"
                ...
                <div className="blog-content">
                  ...
                  <p className="blog-text">
                  In the Flipkart GRiD 5.0 Robotics Challenge, we successfully qualified for the first round. second round, working on a web project. This challenge has been a great opportunity to apply my skills in a competitive and innovative environment.
                  </p>
                </div>
              </a>
            </li>
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://d8it4huxumps7.cloudfront.net/uploads/images/opportunity/mobile_banner/6687c5b94b180_flipkart-grid-60-robotics-challenge.png?d=700x400"
                ...
                <div className="blog-content">
                  <div className="blog-meta">
                    <p className="blog-category">Design</p>
                    <span className="dot" />
                    <time dateTime="2022-02-23">Aug 08, 2024</time>
                  </div>
                  <h3 className="h3 blog-item-title">Flipkart GRiD 6.0 </h3>
                  <p className="blog-text">
                  GRiD is Flipkart’s Flagship Engineering Campus Challenge of E-Commerce technical knowledge and skills but not qualify the exam
                  </p>
                </div>
              </a>
            </li>
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://be10x.in/wp-content/uploads/2023/10/Red-Abstract-YouTube-Thumbnail-1-1024x576.jpg"
                ...
                <div className="blog-content">
                  <div className="blog-meta">
                    <p className="blog-category">Design</p>
                    <span className="dot" />
                    <time dateTime="2022-02-23">Jul 21, 2024</time>
                  </div>
                  <h3 className="h3 blog-item-title">
                  Learn to use AI Tools & ChatGPT
                  </h3>
                  <p className="blog-text">
                  Attended a 3-hour session focused on AI and ChatGPT prompts, where I gained valuable insights and learned new skills.
                  </p>
                </div>
              </a>
            </li>
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://www.grapestechsolutions.com/wp-content/uploads/2023/09/what-is-strapi.jpg"
                ...
                <div className="blog-content">
                  <div className="blog-meta">
                    <p className="blog-category">Design</p>
                    <span className="dot" />
                    <time dateTime="2022-02-23">Jun 23, 2024</time>
                  </div>
                  <h3 className="h3 blog-item-title">
                    Strapi Open API rest
                  </h3>
                  <p className="blog-text">
                    start a new projects in Ecom
                  </p>
                </div>
              </a>
            </li>
            <li className="blog-post-item">
              <a href="#">
                <figure className="blog-banner-box">
                  <img
                    src="https://media.licdn.com/dms/image/D4D12AQGKEapRbPK2aA/article-cover_image-shrink_720_1280/0/1696923705582?e=2147483647&v=beta&t=3rJWtbIEMRibcRShRkGXoTrrxG54b3vDGIPqQZRX9rw"
                ...
                <div className="blog-content">
                  <div className="blog-meta">
                    <p className="blog-category">Design</p>
                    <span className="dot" />
                    <time dateTime="2022-02-23">jul 20, 2024</time>
                  </div>
                  <h3 className="h3 blog-item-title">Starting Next.JS</h3>
                  <p className="blog-text">
                    Working or learning a greate experience in Next.js
                  </p>
                </div>
              </a>
            </li>
